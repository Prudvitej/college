...
foreach ($semesters as $key => $semester) {
    ...
    $pdf->Cell(35, 10, substr($subject, 0, 8), 1);
    $pdf->Cell(30, 10, substr($labname, 0, 10), 1);
        ...
        <form method="post" onsubmit="return validateForm();">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" id="reg_form" name="reg_form" placeholder="Enter Registration Number" required /></td>
                </tr>
                <tr>
